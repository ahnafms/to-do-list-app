                ...
                <div class="bg-slate-100 rounded-lg">
                    <div class="flex flex-row justify-between p-3">
                        ...
                        <div class="w-6 h-6 flex content-center bg-slate-300 rounded-full">
                            <div class="text-base text-slate-800 font-[500] m-auto text-center"><i class="fa fa-thumb-tack" aria-hidden="true"></i></div>
                        </div>
                    </div>
                    
                    <div class="text-3xl text-center text-green-300 p-3  font-semibold">
                        <button 
                        @click="addData(title, desc, 1)" class=" bg-slate-200 hover:bg-slate-400 mb-3 text-base w-full rounded-md">
