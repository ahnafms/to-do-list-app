    ...
    <div class="flex flex-row justify-between p-3">
        ...
        <div class="w-6 h-6 rounded-full bg-slate-300">
            <div class=" m-auto text-slate-800 text-base font-[500] text-center">
              <router-link to="/progress"><i class="fa fa-spinner" aria-hidden="true"></i></router-link></div>
        </div>
    </div>
    <div class="text-3xl text-center text-green-300 p-3  font-semibold">
        <button 
        @click="addData(title, desc, 2)" class=" bg-slate-200 hover:bg-slate-400 mb-3 text-base w-full rounded-md">
